...
<body>
    ...
    <form method="post" action="../controllers/loginCheck.php">
        Email: <input type="text" name="email" value="<?php if(isset($_SESSION['login_old_email'])){ echo htmlspecialchars($_SESSION['login_old_email']); unset($_SESSION['login_old_email']); } ?>"/> <br>
