...
<body>
    ...
    <p id="profile_msg" style="color:red;"><?php if(isset($profileErrors['form'])){ echo $profileErrors['form']; } ?></p>
    <p style="color:red;"><?php if(isset($profileErrors['email'])){ echo $profileErrors['email']; } ?></p>
    <p style="color:red;"><?php if(isset($profileErrors['email_exists'])){ echo $profileErrors['email_exists']; } ?></p>
    <p style="color:red;"><?php if(isset($profileErrors['picture'])){ echo $profileErrors['picture']; } ?></p>
    <p style="color:red;"><?php if(isset($profileErrors['db'])){ echo $profileErrors['db']; } ?></p>
    ...
    <p id="password_msg" style="color:red;"><?php if(isset($passwordErrors['form'])){ echo $passwordErrors['form']; } ?></p>
    <p style="color:red;"><?php if(isset($passwordErrors['current_password'])){ echo $passwordErrors['current_password']; } ?></p>
    <p style="color:red;"><?php if(isset($passwordErrors['new_password'])){ echo $passwordErrors['new_password']; } ?></p>
    <p style="color:red;"><?php if(isset($passwordErrors['confirm_password'])){ echo $passwordErrors['confirm_password']; } ?></p>
    <p style="color:red;"><?php if(isset($passwordErrors['db'])){ echo $passwordErrors['db']; } ?></p>
